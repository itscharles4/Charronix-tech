...
function generateAttendanceRecords(studentId, year, month, markedById) {
    const records = [];
...
function generateNotifications(userId, count = 5) {
    const notifications = [];
...
seedCompleteData();
//# sourceMappingURL=seed-complete-attendance.js.map