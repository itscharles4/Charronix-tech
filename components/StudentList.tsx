...
import { Plus, Upload, Search, Edit2, Trash2, Eye, X, User, Phone, Hash, BookOpen, UserPlus, Loader2 } from 'lucide-react';
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {isLoading ? (
                <tr>
                  <td colSpan={6} className="px-10 py-12 text-center text-slate-500 dark:text-slate-400">
                    <div className="flex flex-col items-center justify-center gap-3">
                      <Loader2 className="animate-spin text-indigo-500" size={32} />
                      <p className="text-sm font-bold uppercase tracking-widest">Loading Live Students Data...</p>
                    </div>
                  </td>
                </tr>
                ...
                filteredStudents.map((student) => (
                  ...
                  >
                    ...
                    <td className="px-10 py-6">
                      <p className="text-sm font-black text-slate-800 dark:text-slate-100">{student.parentName || 'N/A'}</p>
                      <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest mt-1">{student.parentPhone || 'No Contact'}</p>
                    </td>
                    <td className="px-10 py-6">
                      <div className="flex items-center gap-4">
                        <button
